export const environment = {
    ...
    isLogEnabled: true,
    envMode: "offline",
    witsmlUrl: window.location.protocol + "//" + 'VSC-MS-12'+ ":54502/api/v1/",
    baseUrl: window.location.protocol + "//" +'VSC-MS-12' + ":54501/api/v1/",
    signalRUrl: window.location.protocol + "//" + 'VSC-MS-12' + ":54501/ServerRealtimeService/",
